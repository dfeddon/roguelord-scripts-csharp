...
public class EffectSettings_override : MonoBehaviour
{
  ...
  public void OnCollisionHandler(CollisionInfo e)
  {
    ...
    {
      handler(this, e);
      CharController cc = e.Hit.collider.GetComponent<CharController>();// transform.parent.gameObject.OnCollisionHandler(this);
      cc.OnCollisionEnter();
    }
...
public class CollisionInfo_override : EventArgs
{
