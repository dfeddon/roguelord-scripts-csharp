...
namespace Missions
{
    public class Missions_PlayerUI : MonoBehaviour
    {
        ...
        static public Missions.Missions_PlayerUI PlUi;
        private Animator anim;

        void Start()
        {
            Debug.Log("== Missions_PlayerUI.Start ==");
            PlUi = gameObject.GetComponent<Missions.Missions_PlayerUI>();
            red_keys = 0;
            green_keys = 0;
            blue_keys = 0;
            Show_Keys_Count();
